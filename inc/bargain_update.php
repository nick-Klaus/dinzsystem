...
<form class="layui-form" action="">
    <table class="layui-table">
        ...
        <?php
        if( $rs['template'] == "template_two/index" ){
            echo '
            <tr>
            <td height="35" align="right" width="200">活动标题：</td>
            <td><textarea class="layui-textarea" name="title"> '.$rs['title'].'
            </textarea></td>
            </tr>
            <tr >
            <td height="35" align="right" width="200">副标题：</td>
            <td><input name="subtitle" type="text" value="'.$rs['subtitle'].'" placeholder="活动标题"
                       class="layui-input"/></td>
        </tr>';
        }else{
            echo '<tr>
            <td height="35" align="right" width="200">活动标题：</td>
            <td><input name="title" type="text" id="uid" value="'.$rs['title'].'" placeholder="活动标题"
                       class="layui-input"/></td>
        </tr>';
        }
        ...
        <tr>
            ...
            <td>
                <div style="width:70px;height:70px;border:#efefef 1px solid;text-align:center" class="cbox p_mac_logo">
                    ...
                    ?>" id='_imgurl' style="width:100%;height:100%">
                </div>
                <input type="text" name="contact_img" id="_style_thumb" placeholder="图片地址" class="layui-input"
                       style="width:200px;" value="<?= $rs['contact_img'] ?>">
        ...
        <tr>
            <td height="35" align="right" width="200">定金：</td>
            <td><input name="pay_deposit" type="text" value="<?php echo $rs['pay_deposit'] ?>" placeholder="咨询热线"
                       autocomplete="off" class="layui-input"/></td>
        </tr>
