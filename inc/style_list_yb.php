...
<fieldset class="layui-elem-field layui-field-title" style="margin: 20px;">
    ...
    <?php
        if( $c_uid == 177  ){
            $sql = "select * from e_unified_sylte_new  where displays = 0 and adduid='177' and qdz_type=0";
        }else{
            $sql = "select * from e_unified_sylte_new  where adduid > 1 ";
        }
...
<!--        <td><b>现货列表</b></td>-->
    ...
    <tr align='center' style=' background:#ffffff;'>
        <td colspan="9"> <?php echo $pageNavi; ?> 共 <span  style='color:#009688;' ><?php echo $numrows_date; ?></span> 条 </td>
    </tr>
    </table>
</fieldset>
    ...
    function  openpage2( editid ){
        ...
        layer.ready(function() {
            var index = layer.open({
                ...
                maxmin: true,
                area: ['1200px', '800px'],
                content: 'edit_style_yb.php?editid='+editid
            });
        });
    }
    //ajax 删除数据
