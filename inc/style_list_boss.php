...
$c_uid = $_SESSION['uid'];
$sql = "select cuid,categorytype from e_members where uid='$c_uid'";
...
<fieldset class="layui-elem-field layui-field-title" style="margin: 20px;">
    ...
    <form  action="" id='form1'>
        <table class="layui-table">
            <tr style='background:#ffffff;'>
                <td style='border:none;'> <a  onclick='openpage(<?=$cuid?>)'   class="layui-btn" ><i class="layui-icon"></i>款式添加</a></td>
                ...
                <td  colspan="7" style='border:none;'>
                    ...
                    <a href='./style_list_boss.php' class="layui-btn" onclick="look()" >返回</a>
                </td>
    </form>
    </tr>
    <?php

    $sql = "select * from e_goods_sylte  where displays = 0 and adduid='$cuid' and qdz_type=0";
    ...
    while($rs=mysql_fetch_array($results_date))
    {
        ...
        <tr align="center">
            ...
            <td >
                <a onclick='openpage2(<?=$rs['id'] ?>)' title='编辑' class="layui-btn" ><i class="layui-icon"></i></a>
    ...
    function  openpage(cuid){
        ...
        layer.ready(function() {
            var index = layer.open({
                ...
                maxmin: true,
                area: ['1200px', '800px'],
                content: 'add_style.php?cuid='+cuid
            });
        });
    }
    //打开编辑页面的弹出层
