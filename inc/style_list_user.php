...
<fieldset class="layui-elem-field layui-field-title" style="margin: 20px;">
        ...
        <table class="layui-table">
            <tr style='background:#ffffff;'>
                ...
                <td colspan="8" style='border:none;'>
                    ...
                    <a href='./style_list_user.php' class="layui-btn" onclick="look()">返回</a>
                </td>
    </form>
    </tr>
    <form method='post' action="style_all.php" id='form2'>
        ...
        while ($rs = mysql_fetch_array($results_date)) {
            ...
            <tr align="center">
                ...
                <td><a href="#" class="layui-btn">现货列表</a> <?php
                    ...
                    if ($_SESSION['uid'] > 1) {
                        $past_id = "select qdz_type,past_id from e_goods_sylte  where displays = '0' and adduid=" . $_SESSION['uid'];
                        ...
                        if (@in_array($array, $past)) {
                            echo "<a href='style_all.php?del=" . $rs['id'] . "&page=" . $s . "' onclick='look()' class='layui-btn layui-btn-danger' >下架</a>";
                        } else {
                            echo "<a href='style_all.php?add=" . $rs['id'] . "&page=" . $s . "'  onclick='look()' class='layui-btn' >上架</a>";
                        }
                    }
                    ?></td>
            </tr>
        ...
        <tr align='center' style=' background:#ffffff;'>
            <td><?php if ($_SESSION['uid'] > 1) {
                    echo "<button  onclick='look()' class='layui-btn' type='submit'>批量上/下架</button>";
                } ?></td>
