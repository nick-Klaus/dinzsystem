...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend><b>编辑营销配置</b></legend>
</fieldset>

<form class="layui-form" action="">
<input type="hidden" name="id" value='<?php  echo $row['id'] ?>'>
<input type="hidden" name="adduid" value='<?php  echo $row['uid'] ?>'>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
        <textarea placeholder="请输入具体内容" class="layui-textarea layui-hide" name="introduce" lay-verify="content" id="LAY_demo_editor"><?php  echo $row['introduce'] ?></textarea>
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-input-block">
