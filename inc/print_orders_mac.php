   ...
   <tr>
        ...
        <img src="../images/<?php  echo $v['goodstxt']['diamond']['Shape'] ?>.png" style="height:50px;margin-bottom:5px">
         ...
         <td width="50%" style="text-align:left;padding-left:10px"><span>货号:</span><?php  echo $v['goodstxt']['diamond']['Ref'] ?></td>
           <td style="text-align:left">￥<b style="color:red"><?php  echo $v['goodstxt']['diamond']['Rate'] ?></b>元</td>
             </tr>
         <tr>
         <td colspan="2"  style="text-align:left;padding-left:10px">
...
?>
          ...
          if( $v['carttyp'] == 4  ){
              ...
              <table class="layui-table otherTable" style="font-size:.7em;width:100%; border: none;">
                  <tr>
                      ...
                      <td rowspan="3">￥<span style="padding: 0;color: #ff0000;font-weight:bold;"><?php  echo $v['goodstxt']['zdj']['zq']['price'] ?></span>元</td>
                  </tr>
                  <tr>
                      <td   style="text-align:left">
                  ...
                  <tr>
                      ...
                      <td >￥<span style="padding: 0;color: #ff0000;font-weight:bold;"><?php  echo $v['goodstxt']['zdj']['bq2']['price1'] ?></span>元</td>
                  </tr>
                  ...
                  <tr>
                      ...
                      <td rowspan="2">￥<span style="padding: 0;color: #ff0000;font-weight:bold;"><?php  echo $v['goodstxt']['zdj']['bd']['price'] ?></span>元</td>
                  </tr>
                  <tr>
                      <td style="text-align:left">
 ...
 <table class="layui-table" style="font-size:.7em;width:50%;float:left">
   <tr>
         ...
         <td width="50%" style="text-align:left;padding-left:10px"><span>款号:</span><?php  echo $v['goodstxt']['style_no'] ?></td>
           <td>￥<b style="color:red"><?php  echo $v['goodstxt']['G_Goods']['Price'] ?></b>元</td>
             </tr>    
         <tr>
         <td colspan="2"  style="text-align:left;padding-left:10px">
 ...
 <table class="layui-table" style="font-size:.7em;width:50%;float:left">
   <tr>
         ...
         <td width="50%" style="text-align:left;padding-left:10px"><span>款号:</span><?php  echo $v['goodstxt']['style_no'] ?></td>
           <td>￥<b style="color:red"><?php  echo $v['goodstxt']['B_Goods']['Price'] ?></b>元</td>
             </tr>
         <tr>  
         <td colspan="2"  style="text-align:left;padding-left:10px">
  ...
  ?>   
   ...
   <tr>
         ...
         <td width="50%" style="text-align:left;padding-left:10px"><span>款号:</span><?php  echo $v['goodstxt']['style_no'] ?></td>
           <td>￥<b style="color:red"><?php  echo $v['goodstxt']['Goods']['Price'] ?></b>元</td>
             </tr> 
         <tr>
         <td colspan="2"  style="text-align:left;padding-left:10px">
...
?>
  ...
  <?php
    ...
    ?> 
   <tr>
  <td colspan="3" align="right">共 <?php echo $rs['TotalList']?> 件商品，合计 ￥ <b class="price"><?php echo $rs['rmb']?></b> 元</td>
  </tr> 
...
<tr>
<td width="100">销售门店 </td><td><?php echo $rs['store_number']?></td>
</tr>
<tr>
<td width="100">销售员 </td><td><?php echo $rs['sales_person']?></td>
</tr>
<tr>
