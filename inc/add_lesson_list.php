...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend><b>添加课程</b></legend>
</fieldset>

<form class="layui-form" action="">
<input type='hidden' name='stu_id' value="<?php echo $_GET['stu_id'];  ?>">
  <div class="layui-form-item">
    <label class="layui-form-label">课程标题：</label>
    <div class="layui-input-block">
      <input type="text" name="stu_tit" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input">
    </div>
  </div>
    <div class="layui-form-item"> 
    ...
    <div style="height:100px;width:100px; border:1px solid #ccc; margin:0px 0px 15px 0px;">
      ...
      <input type="hidden" name="stu_pic" id="style_thumb"  lay-verify="required" readonly="1" autocomplete="off" placeholder="点击上传图片" class="layui-input"   style="width:300px;" >
    ...
    <div class="layui-input-block">
      <input type="radio" name="stu_type" value="0" title="幻灯片" checked="">
      <input type="radio" name="stu_type" value="1" title="视频">
    </div>
  </div>
    <div class="layui-form-item">
    ...
    <div class="layui-input-block"  >
     <input type="hidden" id="pages" name="thumb_url" lay-verify="user_bz"  readonly="1" autocomplete="off" placeholder="点击上传图片(可上传多张)" class="layui-input" >
...
layui.use(['form', 'layedit', 'laydate'], function(){
  ...
  var adminurl="./addpro_lesson_list.php";
  //创建一个编辑器
