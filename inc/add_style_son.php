    ...
    <tr>
      ...
      <td colspan="3">
        <div class="layui-input-inline" style='height:40px;'>
          <select name="cls1"  disabled >

            <?php
            $arr1 = fetchAll("select id,catename,webid,pid,adduid,box_default_ico from e_goods_category  where  pid=0 and adduid='0'");
        ...
        <div class="layui-input-inline"  >
          <select name="cls2"  lay-filter="test">
            <option value="">请选择子级分类</option>
            <?php
            $arr1 = fetchAll("select id,catename,webid,pid,adduid,box_default_ico from e_goods_category  where  pid='77' ");
            foreach ($arr1 as $v) {
              ?>
...
<select name="cls3" id="smallname" lay-filter="son" >
  <option value="">请选择子级分类</option>
  </select>
 </div>
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        <input name="style_son" type="hidden"   value="error" >
      </td>
    </tr>
    ...
    <tr>
      ...
      <td width="200">
        <input type="radio" value="0" name="style_mode" id="style_mode"  title="现货"  />
        <input type="radio" value="1" name="style_mode"  title="定制" /> <br/>
        <input type="radio" value="2" name="style_mode" id="style_mode"  title="对戒" />
        <input type="radio" value="3" name="style_mode"  title="其它" checked='checked' />
      </td>
...
<input name="MaxStoneWeight" type="hidden" id="MaxStoneWeight"   value="<?=$rs['MaxStoneWeight']?>" size="10" lay-verify="title" autocomplete="off" placeholder="请输入款号或款名" class="layui-input" style='width:200px;' > -->
        <div style='width:400px;height:40px;line-height:40px;' ><input name="S_Weight" type="text" id="MinStoneWeight"  size="5" lay-verify="title" autocomplete="off" placeholder="请输入主石/镶口" class="layui-input" style='width:200px;float:left;' > <span style='color:#019F95;font-size:12px;margin-left:5px;'>单位:（ct/克拉）</span></div>
