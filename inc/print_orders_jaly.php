...
<div class="layui-tab-item layui-show">
   <div style='text-align:center;margin-bottom:20px;font-weight:bold;font-size:16px;'>金嘉利客户订单</div>

<table width="100%" >
<tr style='height:30px;'><td width="60">订单号：</td><td><?=$rs['order_no']?></td><td width="60">日期：</td><td><?php echo date("Y-m-d",time()) ?></td></tr>
<tr style='height:30px;'><td width="60" >客户：</td><td><?=$rs['lxr']?></td><td width="60">电话：</td><td><?=$rs['mob']?></td></tr>
</table>
...
<table width="100%">
  <tr><td>订单确认：</td><td>财务：</td><td>下单确认：</td><td>质检：</td></tr>
  
</table>
</div>
</form>
<!-- <a href="javascript:prn3_preview()" class="layui-btn" id='layui-btn'>打印订单</a> -->
<input type="button" class="noprint" value=" 打 印 "  style="width:100px;height:35px;background:#1AA094;border:none;color:#ffffff;-webkit-border-radius:3px;margin-top:30px; "  onclick="xx()">
