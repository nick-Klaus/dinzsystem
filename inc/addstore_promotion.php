...
<form class="layui-form" action="">
  <div class="layui-form-item">
    ...
    <div style="height:100px;width:100px; border:1px solid #ccc; margin:0px 0px 15px 0px;">
      ...
      <button type="button" id="style_thumb_cl" class="layui-btn layui-btn-radius" style='margin-top:10px;'>点击选图（尺寸：384*216）</button>
    </div>
  </div>
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
    <div style="height:100px;width:100px; border:1px solid #ccc; margin:0px 0px 15px 0px;">
       <img  id='imgurl_1' style="height:100px;width:100px;" src="../images/timg.jpg">
    </div>
      <input type="hidden" name="service_page" id="style_thumb_1"  lay-verify="required" readonly="1" autocomplete="off" placeholder="点击上传图片" class="layui-input"   style="width:300px;" >
      <button type="button" id="style_thumb_1_cl" class="layui-btn layui-btn-radius" style='margin-top:10px;'>点击选图（尺寸：1920*1080）</button>
    </div>
  </div>
    <div class="layui-form-item">
